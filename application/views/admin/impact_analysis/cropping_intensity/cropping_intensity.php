<div class="row">
    <div class="col-md-6">
        <h4>Average Increase in Cropping Intensity</h4>
        <small>Analysis of total <strong><?php
                                            $query = "SELECT COUNT(*) as total FROM `impact_crop_intensity`";
    ...
    <div class="col-md-6" style="text-align: right;">
        <a target="new" href="<?php echo base_url('admin/impact_analysis/export_data/Cropping_Intensity_Raw'); ?>" class="btn btn-success btn-sm"><i class="fa fa-download" aria-hidden="true"></i> Raw Data</a>
        <a target="new" href="<?php echo base_url('admin/impact_analysis/export_data/Cropping_Intensity_Compiled'); ?>" class="btn btn-warning btn-sm"><i class="fa fa-download" aria-hidden="true"></i> Compiled Data</a>
        <button class="btn btn-danger btn-sm" onclick="exportMultipleTablesToExcel('Cropping_Intensity',['table_1', 'table_2', 'table_3', 'table_4'], ['Sheet1', 'Sheet2', 'Sheet3', 'Sheet4'])"><i class="fa fa-download" aria-hidden="true"></i> Export Data in Excel</button>
    </div>
</div>
...
<?php
$query = "SELECT `region` FROM `impact_crop_intensity` 
GROUP BY `region` ASC;";
$regions_result = $this->db->query($query);
$regions = $regions_result->result();
$query = "SELECT `component` FROM `impact_crop_intensity` 
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <strong>Average Increase in Cropping Intensity </strong>
            </div>
    ...
    <div class="col-md-6">
        ...
        <script>
            Highcharts.chart('cca_summary', {
                ...
                title: {
                    text: 'Increase in Cropping Intensity Summary'
                },
                xAxis: {
    ...
    <script>
        Highcharts.chart('areaChart', {
            ...
            title: {
                text: 'Cropping Intensity Before and After'
            },
            xAxis: {
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow-sm mb-4" style="margin-top: 8px;">
            <div class="card-header bg-primary text-white">
                <strong>Average Increase in Cropping Intensity by Region and Component Wise</strong>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                        ...
                        <thead class="thead-light">
                            <tr>
                                <th style=" display:none; text-align:center" colspan="<?php //echo (1 + (count($component) * 4) + 4) 
                                                                                        ?>">Average Increase in Cropping Intensity by Region and Component Wise</th>
                            </tr>
                            <tr>
...
<div class="row">
    <?php $query = "SELECT `sub_component` FROM `impact_crop_intensity`
    ...
    <div class="col-md-12">
        <div class="card shadow-sm mb-4" style="margin-top: 8px;">
            <div class="card-header bg-primary text-white">
                <strong>Average Increase in Cropping Intensity by Region and Sub Component Wise</strong>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                        ...
                        <thead class="thead-light">
                            <tr>
                                <th style=" display:none; text-align:center" colspan="<?php //echo (1 + (count($categorys) * 4)) 
                                                                                        ?>">Average Increase in Cropping Intensity by Region and Sub Component Wise</th>
                            </tr>
                            <tr>
                                <th rowspan="2" class="align-middle">Regions</th>
...
<div class="row">
    <?php
    $query = "SELECT `category` FROM `impact_crop_intensity`
    ...
    <div class="col-md-12">
        <div class="card shadow-sm mb-4" style="margin-top: 8px;">
            <div class="card-header bg-primary text-white">
                <strong>Average Increase in Cropping Intensity by Region and Categories Wise</strong>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table id="table_4" class="table table-bordered table-hover table_small">
                        <thead class="thead-light">
                            <tr>
                                <th style=" display:none; text-align:center" colspan="<?php //echo (1 + (count($categorys) * 4)) 
                                                                                        ?>">Average Increase in Cropping Intensity by Region and Categories Wise</th>
                            </tr>
                            <tr>
                                <th rowspan="2" class="align-middle">Regions</th>
