...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <table class="table table-bordered table_medium">
            <thead>
                <tr>
                    <th colspan="<?php echo (count($components) * 3) + 4; ?>">Increase in Maize Hybrid Yield (ton/ha)</th>
                </tr>
                <tr>
                    <th rowspan="2">Regions</th>
                    <?php foreach ($components as $component) { ?>
        ...
        <div id="maize_hybrid_yield" style="width:100%;"></div>
        <script>
            Highcharts.chart('maize_hybrid_yield', {
                chart: {
                    type: 'column'
                },
                title: {
                    text: 'Increase in Maize Hybrid Yield (ton/ha)'
                },
                xAxis: {
                    categories: [
                        <?php foreach ($components as $component) {
